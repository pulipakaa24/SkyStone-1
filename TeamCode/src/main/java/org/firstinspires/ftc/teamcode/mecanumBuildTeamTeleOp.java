...
@TeleOp(name="MecanumBuildTeamTeleOp", group="Zippo")
//@Disabled
...
public class mecanumBuildTeamTeleOp extends OpMode{

    mecanumBuildTeamHardware robot  = new mecanumBuildTeamHardware();
